...
<body class="container-fluid">
	...
	<div class="row">
		<div class="col-lg-8">
			...
			<?php if($_SESSION["uid"] == $_GET["uid"]):?>
				...
				<div class="row profileRow">
					<div class="col-sm-6 text-center">
						...
						<?php echo "'modUser.php?uid=" . $_GET["uid"]. "'";?>, '_self')" />
					</div>
					<div class="col-sm-6 text-center">
				...
				<div class="row profileRow">
					<div class="col-sm-6 text-center">
						<input type="button" class="formBtn" value="Disable account" onclick="window.open(
							<?php echo "'utl/disableAcc.php?uid=" . $_GET["uid"]. "'";?>, '_self')" />
					</div>
					<div class="col-sm-6 text-center">
			...
			<?php  endif; ?>
			<?php if($_SESSION["gid"] == 1 && $_SESSION["uid"] != $_GET["uid"]):?>
				<hr/>
				<div class="row profileRow">
					<div class="col-sm-6 text-center">
						<input type="button" class="formBtn" value="Modify personal info" onclick="window.open(
				...
				<div class="row profileRow">
					<div class="col-sm-6 text-center">
						<?php 
							...
							if($rs->status == 0){
								echo "value=\"Disable account\" onclick=\"window.open('utl/disableAcc.php?uid=" . $_GET["uid"]. "', '_self')\" />";
							}else{
								echo "value=\"Enable account\" onclick=\"window.open('utl/enableAcc.php?uid=" . $_GET["uid"]. "', '_self')\" />";
							}
						 ?>
					</div>
					<div class="col-sm-6 text-center">
